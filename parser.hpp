...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_T_EQUAL ()
      {
        return symbol_type (token::T_EQUAL);
      }
#else
      static
      symbol_type
      ...
      make_T_CONST ()
      {
        return symbol_type (token::T_CONST);
      }
#else
      static
      symbol_type
      ...
      make_T_ELSE ()
      {
        return symbol_type (token::T_ELSE);
      }
#else
      static
      symbol_type
      ...
      make_T_BREAK ()
      {
        return symbol_type (token::T_BREAK);
      }
#else
      static
      symbol_type
      ...
      make_T_CONTINUE ()
      {
        return symbol_type (token::T_CONTINUE);
      }
#else
      static
      symbol_type
      ...
      make_T_ADD ()
      {
        return symbol_type (token::T_ADD);
      }
#else
      static
      symbol_type
      ...
      make_T_SUB ()
      {
        return symbol_type (token::T_SUB);
      }
#else
      static
      symbol_type
      ...
      make_T_MUL ()
      {
        return symbol_type (token::T_MUL);
      }
#else
      static
      symbol_type
      ...
      make_T_DIV ()
      {
        return symbol_type (token::T_DIV);
      }
#else
      static
      symbol_type
      ...
      make_T_MOD ()
      {
        return symbol_type (token::T_MOD);
      }
#else
      static
      symbol_type
      ...
      make_T_NOT ()
      {
        return symbol_type (token::T_NOT);
      }
#else
      static
      symbol_type
      ...
      make_T_AND ()
      {
        return symbol_type (token::T_AND);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_T_IDENT (const char * v)
      {
        return symbol_type (token::T_IDENT, std::move (v));
      }
#else
      static
      symbol_type
      make_T_IDENT (const const char *& v)
      {
        return symbol_type (token::T_IDENT, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_T_DECIMAL (int v)
      {
        return symbol_type (token::T_DECIMAL, std::move (v));
      }
#else
      static
      symbol_type
      make_T_DECIMAL (const int& v)
      {
        return symbol_type (token::T_DECIMAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      make_T_OCTAL (int v)
      {
        return symbol_type (token::T_OCTAL, std::move (v));
      }
#else
      static
      symbol_type
      make_T_OCTAL (const int& v)
      {
        return symbol_type (token::T_OCTAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_T_HEXADECIMAL (int v)
      {
        return symbol_type (token::T_HEXADECIMAL, std::move (v));
      }
#else
      static
      symbol_type
      make_T_HEXADECIMAL (const int& v)
      {
